...
const CoreGame = () => {
  ...
  //   minDistance: { value: 0 },
  //   saveState: button(() => console.log("saveState button clicked")),
  //   reset: button(() => console.log("reset button clicked")),
  ...
  function updateInitStatus(obj) {
    ...
    return (
      <>
        ...
        {settings.hideTextureSelector ? <></> : <TextureSelector activeTextureREF={activeTextureREF} />}
        ...
        <Canvas>
          ...
          {settings.orbitalControlsEnabled ? <OrbitControls /> : <></>}
