...
export const Ground = ({sizeX=5,sizeZ=5, heightY=-.5}) => {
    ...
    const [ref,api] = useBox (() => ({
        ...
        args:[sizeX,sizeZ,.1],
        position: [sizeX/2-.5,-.6,sizeZ/2-.5]
    }))
    ...
    function clickGroundFace(e){
            ...
            // console.log('aft-intersect: ',intersect)
            // console.log('faceIND: ',intersect[0].faceIndex)
            ...
            if(intersect.length>0){
                    ...
                    // console.log('math: z-x',nbZ,'-',nbX)
                    // console.log(currblocks[makeKey(nbX,0,nbZ)])
                    if(!currblocks[makeKey(nbX,0,nbZ)]){
                        console.log('ground add cube')
